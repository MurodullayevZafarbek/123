export default ({data, sort, dn,dn1}) => { 
    console.log(data);
    return(
        <>
        ...
        <table className="w-full text-sm  text-gray-400 p-10">
            ...
            <tbody>
                <tr className="bg-gray-800 hover:bg-gray-600">
                    ...
                    <a href="/group " className="px-6 py-4">{data.name}</a>
                    </td>
                    <td className="px-6 py-4">
                    <a className="px-6 py-4">{data.age}</a>
                    </td>
                    <td className="px-6 py-4 w-32">
                        <button onClick={(e)=>{dn1(e,data.id)}} data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
                            href="#" className="font-medium text-blue-500 hover:underline "><i
                                className="fa-solid fa-pen">EDIT</i></button>
                        <button onClick={(e)=>{dn(e,data.id)}} className="ml-3 font-medium text-blue-500 hover:underline"><i
